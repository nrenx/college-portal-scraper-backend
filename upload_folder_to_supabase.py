...
BUCKET_NAME = getattr(supabase_config, "DEFAULT_SETTINGS", {}).get("bucket", "demo-usingfastapi")
SOURCE_DIR = getattr(supabase_config, "DEFAULT_SETTINGS", {}).get("source_dir", "student_details")
WORKERS = getattr(supabase_config, "DEFAULT_SETTINGS", {}).get("workers", 32)
